...
%\begin{align}
%	\begin{split}
%		\hat{\tilde{H}}_R(t)= &\frac{1}{2}\lbrace\Omega_{21}\cos(2\kr x+(\bar{\omega}-\omega_{21}) t ++\phi_1)+\Omega_{31}\cos(2\kr x+(\bar{\omega}-\omega_{31}) t -\frac{\phi_1}{2}) \\
%		& +\Omega_{41}\cos(2\kr x+(\bar{\omega}-\omega_{41}) t + \phi_2)\rbrace \hat{F}_x \\
%		& -  \frac{1}{2}\lbrace\Omega_{21}\sin(2\kr x+(\bar{\omega}-\omega_{21}) t +\phi_1)+\Omega_{31}\sin(2\kr x+(\bar{\omega}-\omega_{31}) t-\frac{\phi_1}{2})\\
